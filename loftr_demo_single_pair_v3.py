...
img0_rgb = cv2.resize(img0_rgb, (640, 480))
...
image_source, image = load_image_fsu(IMAGE_PATH, 640, 480)
...
for box in boxes_xyxy:
  ...
  polygon_test= np.transpose(blueballshape)
  ...
  #print(picture1points)
  #print(mconf)
  color = cm.jet(matchconf, alpha=0.7)
  text = [
    'LoFTR',
