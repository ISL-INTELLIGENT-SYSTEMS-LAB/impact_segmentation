...
# Stage Setup
file_path = r"usd_outputfiles\flag.usda"
...
flag_cols = 20
flag_rows = 10
flag_texture_path = r"_assets\flag.jpg"
...
# Transform Flag
UsdGeom.XformCommonAPI(flag_mesh).SetRotate(Gf.Vec3f(90,0,0))
UsdGeom.XformCommonAPI(flag_mesh).SetTranslate(Gf.Vec3d(0,3,0))

# Scale assembly
UsdGeom.XformCommonAPI(flag_assembly).SetScale(Gf.Vec3f(1.0,1.0,1.0))
