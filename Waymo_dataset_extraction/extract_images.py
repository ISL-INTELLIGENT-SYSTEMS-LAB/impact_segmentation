...
def extract_images(image_file, segmentation_file, output_dir="extracted_images"):
    ...
    seg_context_col = 'key.segment_context_name'
    ...
    segmentation_keys = set(
        (segmentation_table[seg_context_col][i].as_py(),
    ...
    print()
    for idx in tqdm(range(image_table.num_rows), desc="Extracting Images"):
        key_tuple = (
            image_table[seg_context_col][idx].as_py(),
            image_table[seg_timestamp_col][idx].as_py(),
        ...
        if key_tuple in segmentation_keys:
            ...
            if image_data:
                ...
                if img is not None:
                    ...
                    filename = f"image_{key_tuple[1]}_{key_tuple[2]}.png"
